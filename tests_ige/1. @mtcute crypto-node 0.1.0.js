...
// @mtcute/crypto-node@0.1.0 doesn't export native
const native_cjs_1 = require("../node_modules/@mtcute/crypto-node/cjs/native.cjs");
const { ige256_decrypt, ige256_encrypt } = native_cjs_1.native;
